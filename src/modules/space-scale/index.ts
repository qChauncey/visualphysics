    ...
    return [
      {
        ...
        options: [
          { value: 'comparison', label: '大小对比（并排展示）', labelEn: 'Size comparison (side by side)' },
          { value: 'orbit',      label: '轨道运动（缩放轨道）', labelEn: 'Orbital motion (scaled orbits)' },
        ],
        default: 'comparison',
      },
      {
      ...
      },
      {
        ...
        id:      'sizeExp',
        label:   '星球放大倍率（轨道模式）',
        labelEn: 'Planet scale factor (orbit mode)',
        min:     1,
        max:     80,
        step:    1,
        default: 30,
      ...
      },
      {
        ...
        id:      'camDist',
        label:   '镜头距离（轨道模式）',
        labelEn: 'Camera distance (orbit mode)',
        min:     50,
        max:     400,
        step:    10,
        default: 150,
